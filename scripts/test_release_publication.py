...
REPO, TAG = "leodotsinc/blog", "v0.1.0"
...
class PublicationTests(unittest.TestCase):
    def setUp(self):
        ...
        built = create(service="blog", compose_project="leodotsdev", application_kind="first_party",
            app_version="0.1.0", release_version="0.1.0", git_sha=REVISION,
            source_repository="https://github.com/" + REPO,
            image="ghcr.io/leodotsinc/blog@sha256:" + "d" * 64,

...
class FunctionalReceipt(unittest.TestCase):
    ...
    def test_workflows_retain_receipt_seven_days_without_changing_rollout_gate(self):
        ...
        self.assertIn("inputs.maintenance_context != '' && needs.maintenance_metadata.result == 'success'",deploy)
        self.assertIn("inputs.maintenance_context == '' && (github.event_name != 'workflow_dispatch' || inputs.prepare_only == false)",deploy)
